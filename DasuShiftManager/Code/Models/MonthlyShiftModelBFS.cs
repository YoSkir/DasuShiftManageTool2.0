...
public class MonthlyShiftModelBFS : IMonthlyShiftModel
{
    ...
    public MonthlyShiftModelBFS(int id, DateOnly firstDay,Setting setting,List<Employee> employees)
    {
        Id = id;
        StartDate=firstDay;
    ...
    public MonthlyShiftModelBFS(MonthlyShiftModelBFS copyShift, int id)
    {
        Id = id;
